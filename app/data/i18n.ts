...
export const dictionary: Record<Language, Dictionary> = {
  es: {
    title: "MIS NOTAS",
    subtitle:
      "Se guardan automáticamente <br /> en el <strong>almacenamiento local</strong> de tu navegador",
    ...
    ariaEmojis: "Mil Emojis",
    ariaHome: "Inicio",
    ariaMusic: "Música",
    moveUp: "Mover Arriba",
    moveDown: "Mover Abajo",
    goToHome: "Ya estás acá!",
    goToEmojis: "Ir a Mil Emojis",
    goToMusic: "Ir a Music",
    goToPlay: "Jugar Antipala",
    noTag: "Sin Tag",
  },
  en: {
    title: "MY NOTES",
    subtitle:
      "Automatically saved <br /> in your browser's <strong>local storage</strong>",
    ...
    goToEmojis: "Go to Mil Emojis",
    goToMusic: "Go to Music",
    moveUp: "Move Up",
    moveDown: "Move Down",
    goToPlay: "Go Play Antipala",
    noTag: "No Tag",
  },
};
